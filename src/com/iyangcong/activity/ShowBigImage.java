...
import com.iyangcong.task.LoadLocalBigImgTask;
import com.iyangcong.utils.ImageCache;
import com.iyangcong.widget.photoview.PhotoView;
...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = R.drawable.photo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.photo);
