...
import com.iyangcong.db.InviteMessgeDao;
import com.iyangcong.db.UserDao;
import com.iyangcong.domain.InviteMessage;
import com.iyangcong.domain.InviteMessage.InviteMesageStatus;
...
//		addToGroup();
		// ////////////////////////////////////////////////////////////
		// 如果登录的名字一样，就不需要重复加群，如不新名字入驻，两个名字不一样，需要加群
		// name = DemoApplication.getInstance().getUserName();
		//
		//
		//
		//
		...
		//
		// try {
		// EMGroupManager.getInstance().createPublicGroup("猿圈儿官方群",
		// "感谢大家对猿圈儿的支持，能够成为一名程序猿本身就是我们的荣幸！", str, false);
		// //群主加人调用此方法
		// EMGroupManager.getInstance().addUsersToGroup("猿圈儿官方群", str);
		// //私有群里，如果开放了群成员邀请，群成员邀请调用下面方法
		// EMGroupManager.getInstance().inviteUser("猿圈儿官方群", str, null);
		// } catch (EaseMobException e) {
		// // TODO Auto-generated catch block
		// e.printStackTrace();
		// }
		...
		// } else {
		// Log.d("debug", "不是第一次运行");
		// String n2 = sharedPreferences.getString("name", "0");
		//
		// if(name.equals(n2)){
		// System.out.println("名字相等");
		//
		// }else{
		// try {
		// EMGroupManager.getInstance().createPublicGroup("猿圈儿官方群",
	...
	private class MyGroupChangeListener implements GroupChangeListener {
		...
		public void onInvitationReceived(String groupId, String groupName,
			...
			msg.addBody(new TextMessageBody("给大家打个招呼吧！" + inviter));
			// 保存邀请消息
...
//		pd.show();
		new Thread(new Runnable() {
			public void run() {
				try {
					//如果是membersOnly的群，需要申请加入，不能直接joingroup.isMembersOnly()
